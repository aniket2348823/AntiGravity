...
class PDFReport(FPDF):
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 10, 'Aether-Titan v100 Omega - Sovereign Report (Confidential)', 0, 0, 'L')
            self.ln(10)
...
def generate_pdf(scan_data, output_path):
    ...
    pdf.cell(0, 10, 'Generated by Aether-Titan v100 Omega (Absolute-Singularity)', 0, 1, 'C')
    ...
    if not vulnerabilities:
        ...
        for i, vuln in enumerate(vulnerabilities, 1):
            ...
            pdf.set_font('Arial', 'B', 12)
            pdf.cell(0, 8, "3. Proof of Concept (PoC) & Evidence", 0, 1)
            pdf.set_font('Arial', '', 10)
            ...
            # Clean up the evidence text for PDF printing
            ...
            pdf.set_font('Arial', 'B', 12)
            pdf.cell(0, 8, pdf.safe_text("5. Recommended Remediation"), 0, 1)
            ...
            # 6. References
            pdf.set_font('Arial', 'B', 12)
            pdf.cell(0, 8, pdf.safe_text("6. References"), 0, 1)
            pdf.set_font('Arial', '', 10)
